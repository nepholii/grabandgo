...
<head>
    ...
    <style>
        * {
        ...
        /* Specific meta info styles */
        .orderDate-info .meta-value {
            color: #FFCC00;
            font-weight: 500;
        }

        .pickupTime-info .meta-value {
            color: #FF3C00;
            font-weight: 500;
        }

        .payment-info .meta-value {
            text-transform: capitalize;
        }

        .total-info .meta-value {
            font-weight: bold;
            color: #4CAF50;
        }
                ...
                <c:forEach items="${ongoingOrders}" var="order">
                    <div class="order-card ongoing">
                        ...
                        <div class="order-meta">
                            <div class="orderDate-info">
                                <span class="meta-label">Ordered Date:</span>
                                <span class="meta-value"><fmt:formatDate value="${order.pickupTime}" pattern="MMM dd, yyyy"/></span>
                            </div>
                            
                            <div class="pickupTime-info">
                                <span class="meta-label">Pickup Time:</span>
                                <span class="meta-value"><fmt:formatDate value="${order.pickupTime}" pattern="hh:mm a"/></span>
                            </div>
